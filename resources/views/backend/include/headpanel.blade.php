            ...
            <nav class="nav">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-header wd-250">
                        <div class="tx-center">
                            <a href="{{ route('dashboard') }}""><img src="https://via.placeholder.com/500"
                        ...
                        <ul class="list-unstyled user-profile-nav">
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <li><button class="btn btn-primary" href="{{ route('logout') }}"><i
                                            class="icon ion-power"></i> Sign Out</button></li>
                            </form>
                        </ul>
                    </div><!-- dropdown-menu -->
                </div><!-- dropdown -->
